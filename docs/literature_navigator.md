...
| --- | --- | --- |
| Can a system recover every supporting document? | [PathRetriever](https://openreview.net/forum?id=SJgVHkrYDH) → [MDR](https://arxiv.org/abs/2009.12756) | [Baleen](https://openreview.net/forum?id=Ghk0AJ8XtVx) and [Beam Retrieval](https://aclanthology.org/2024.naacl-long.96/) for more structured search. |
...
- [PathRetriever (2020)](https://openreview.net/forum?id=SJgVHkrYDH) and [MDR (2021)](https://arxiv.org/abs/2009.12756) — sequential and dense retrieval for open-domain multi-hop QA.
...
### Selection: preserve the chain under a budget
...
| 2021 | [Fusion-in-Decoder](https://arxiv.org/abs/2007.01282), [MDR](https://arxiv.org/abs/2009.12756), [Baleen](https://openreview.net/forum?id=Ghk0AJ8XtVx), [RERC](https://aclanthology.org/2021.findings-emnlp.17/) | Reader / Retrieval / Decomposition | Fusion / Observability |
