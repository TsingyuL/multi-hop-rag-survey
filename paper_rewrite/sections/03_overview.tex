...
% Figure 1 will visualize the functional process:
% original task -> initial retrieval -> follow-up retrieval loop ->
% evidence integration -> answer/report, with a cross-task feedback loop.
% \paperfigure{1.0}{fig1_process.pdf}{...}{fig:process}
...
The taxonomy follows the information flow rather than a specific architecture. Table~\ref{tab:taxonomy_overview} summarizes the four categories.
...
% Figure 2 will present the full taxonomy tree with the subsection structure
% used in Sections 4--7.
% \paperfigure{1.0}{fig2_taxonomy.pdf}{...}{fig:taxonomy}
