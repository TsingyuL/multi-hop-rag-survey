...
\foreach \subnode/\yy in {s41/16.00,s42/15.20,s43/14.40,s44/13.60}{
  \draw[branch] (4.80,\yy) -- (\subnode.west);
}
...
\foreach \subnode/\yy in {s51/12.60,s52/11.80,s53/11.00,s54/10.20,s55/9.40,s56/8.60}{
  \draw[branch] (4.80,\yy) -- (\subnode.west);
}
...
\foreach \subnode/\yy in {s61/7.60,s62/6.80,s63/6.00,s64/5.20,s65/4.40}{
  \draw[branch] (4.80,\yy) -- (\subnode.west);
}
...
\foreach \subnode/\yy in {s71/3.40,s72/2.60,s73/1.80,s74/1.00,s75/0.20}{
  \draw[branch] (4.80,\yy) -- (\subnode.west);
}
